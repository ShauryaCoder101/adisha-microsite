...
export default function DanceVideosPage({ apiBase }) {
    ...
    <>
      ...
      <section className="page-banner">
        <div className="container">
          ...
          <h1>Dance Videos</h1>
          <p>
            Relive the incredible dance performances and freestyle moves from the celebration night!
          </p>
      ...
      <section className="section">
        <div className="container">
          {loading && <Loader text="Loading dance videos..." />}
          ...
          {!loading && !error && snippets.length === 0 && (
            <div className="empty-state animate-fade-in">
              ...
              <h3>No Dance Videos Yet</h3>
              <p>Dance videos from the celebration will appear here once they've been uploaded. Check back soon!</p>
            </div>
          )}
